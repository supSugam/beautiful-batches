...
function fitStencilToImage(state, settings, action) {
...
function zoomStencil(state, settings, action) {
    if (helpers.isInitializedState(state) && action.immediately) {
        var result = copyState.copyState(state);
        // Auto size
        var stencil = {
