...
function anchoredResizeCoordinatesAlgorithm(coordinates, anchor, directions, options, limitations) {
    ...
    var allowedDirections = anchorToAllowedDirections(anchor);
    var result = resizeCoordinatesAlgorithm(coordinates, resizeDirections, tslib.__assign(tslib.__assign({}, options), { allowedDirections: allowedDirections }), limitations);
    if (reference) {
...
exports.anchorMoveToResizeDirections = anchorMoveToResizeDirections;
exports.anchorToAllowedDirections = anchorToAllowedDirections;
