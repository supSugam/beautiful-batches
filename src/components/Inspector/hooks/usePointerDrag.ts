...
type UsePointerDragArgs = {
  onMove?: (payload: DragMovePayload) => void;
  onMoveStart?: (payload: DragStartPayload) => void;
  onMoveEnd?: (payload: DragEndPayload) => void;
};

export function usePointerDrag({ onMove, onMoveStart, onMoveEnd }: UsePointerDragArgs) {
